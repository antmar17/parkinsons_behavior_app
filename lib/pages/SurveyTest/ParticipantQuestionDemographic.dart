...
class ParticipantQuestionDemographic extends StatefulWidget {


  @override
  _ParticipantQuestionDemographicState createState() => _ParticipantQuestionDemographicState();
}

class _ParticipantQuestionDemographicState extends State<ParticipantQuestionDemographic> {
  int selectedRadio = 0;
